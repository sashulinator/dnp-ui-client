...
import StringField, { type Props as TextFieldProps } from './ui.integer-field'

interface State {}

export default {
  getName: (): string => StringField.displayName || '',
  ...
  render: function Element(props: Props<State>): JSX.Element {
    ...
    return (
      <Flex width='100%' direction={'column'} p='8' gap='4'>
        <Form form={form}>
          {() => (
            <Field<number, TextFieldProps, HTMLInputElement>
