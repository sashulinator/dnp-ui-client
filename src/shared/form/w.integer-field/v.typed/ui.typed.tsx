...
import { NAME as PARENT_NAME } from '../ui.integer-field'
import TextField, { type Props as TextFieldProps } from '../ui.integer-field'
...
Component.testValueType = (t: number): number => t
