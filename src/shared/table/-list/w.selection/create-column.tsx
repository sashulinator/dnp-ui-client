...
function RenderHeaderCell({ context, list }: RenderHeaderCellProps<Dictionary, Context<Dictionary>>) {
...
function RenderCell({ item, context }: RenderCellProps<Dictionary, Context<Dictionary>>) {
  // eslint-disable-next-line react-hooks/rules-of-hooks
  useSubscribeUpdate((update) => [context.selectedItemsAtom.subscribe(update)])
