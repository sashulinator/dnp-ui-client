...
import { Field, FieldArray, Label, Select, TextField, TypedField, getIn, useForm } from '~/shared/form'
...
export const NAME = 'targetTable-Form-w-Columns'

const FLEX_BASIS = 'calc(25% - 6px)'

/**
 * targetTable-Form-w-Columns'
 */
