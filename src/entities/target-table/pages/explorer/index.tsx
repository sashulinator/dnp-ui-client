...
import { type Column, RowForm, toColumns } from '~dnp/shared/database'
...
import { useSort } from '~dnp/shared/sort'
...
export default function Component(): JSX.Element {
  ...
  const columns = useMemo(
    ...
    () => toColumns((explorerListFetcher.data?.targetTable.columns as any) || []),
  ...
  const indexedColumns = explorerListFetcher.data?.targetTable.columns.filter((item) => item.index)
  ...
  return (
    <main className={NAME}>
      <_Dialog
        ...
        columns={explorerListFetcher.data?.targetTable.columns}
      />
      <_Dialog
        form={formToUpdate}
