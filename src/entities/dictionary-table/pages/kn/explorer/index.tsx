...
import { type Row, type TableSchema, api } from '~/entities/dictionary-table'
import { SYSNAME } from '~/entities/dictionary-table/constants/name'
import ExplorerViewer from '~/entities/dictionary-table/ui/explorer-viewer'
  ...
  return (
    <main className={NAME}>
      <_Dialog
        ...
        tableSchema={explorerListFetcher.data?.dictionaryTable.tableSchema}
      />
      <_Dialog
        form={formToUpdate}
