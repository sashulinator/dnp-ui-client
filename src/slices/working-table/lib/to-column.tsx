import { toFilter } from '~dnp/common/slices/where/lib/to-filter'
...
import { FilterConfigurator, type IntFilter, type IsFilter, type StringFilter, toFilterConfig } from '~dnp/slices/where'
